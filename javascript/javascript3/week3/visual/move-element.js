// Creating new scope
{
  ...
  setInterval(() => {
    ...
    const allTargetsFulfilled = [...targets].every(target => target.classList
      .contains('fulfilled'));
  ...
  function setTargetFulfilled(box, targetBox, fulfilledPosition) {
    ...
    if (renderedClientBox.left === fulfilledPosition.x && renderedClientBox.top ===
      fulfilledPosition.y) {
